print("Welcome to LIstas and Dictonaries!")
...
idx_1 = bob_marley_name.index(" ") # slcing araay
f_bob_marley_name = bob_marley_name[0:idx_1] # should give us Bob Marleys first name
...
print("'in keyword - is number 2 in the list?")
